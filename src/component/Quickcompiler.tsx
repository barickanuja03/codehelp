  ...
  return (
    <>
      <div className='main-container'>
        ...
        <div className='flex flex-col justify-center items-center md:flex-row my-4 md:my-8 hover:border-2 hover:border-pink-700 rounded-xl overflow-x-hidden md:m-5'>
           <div className='lg:w-[50%] flex flex-col flex-wrap gap-y-5 justify-center md:ml-3 px-3'>
